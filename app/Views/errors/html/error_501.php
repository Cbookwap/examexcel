...
<head>
    ...
    <title>Not Implemented - ExamExcel</title>
...
<body>
    <div class="floating-shapes">
        ...
        <div class="shape">
            <i class="fas fa-hammer" style="font-size: 2rem;"></i>
        </div>
    </div>
        ...
        <div class="error-body">
            <div class="error-message">
                <?php if (ENVIRONMENT !== 'production') : ?>
                    <?= nl2br(esc($message)) ?>
                <?php else : ?>
                    This feature is not yet implemented. Our development team is working on bringing you this functionality soon!
                <?php endif; ?>
            </div>
            ...
            <div class="error-suggestions">
                ...
                <ul>
                    <li>This feature is under active development</li>
                    <li>Check back later for updates</li>
                    <li>Contact support for feature requests</li>
                    <li>Explore other available features</li>
                    <li>Subscribe to our updates for notifications</li>
                </ul>
            </div>
