...
<head>
    ...
    <title>Server Error - ExamExcel</title>
    ...
    <div class="error-container">
        <div class="error-header">
            ...
            <?php if (ENVIRONMENT !== 'production') : ?>
                <div class="error-id">Error ID: <?= uniqid('ERR-', true) ?></div>
            <?php endif; ?>
        </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            setTimeout(() => {
                ...
                if (refreshBtn) {
                    refreshBtn.style.background = 'linear-gradient(135deg, var(--success-color) 0%, #48bb78 100%)';
