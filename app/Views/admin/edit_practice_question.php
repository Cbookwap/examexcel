        ...
        <div class="card form-card">
            <div class="card-body p-4">
                <div class="form-header">
                    <h5 class="mb-0">
                        <i class="fas fa-edit me-2"></i>Edit Practice Question
                    </h5>
                </div>

                <?= form_open('admin/practice-questions/update/' . $question['id'], ['class' => 'needs-validation', 'novalidate' => true]) ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="category" id="category" class="form-select" required>
                                ...
                                <option value="English Language" <?= $question['category'] === 'English Language' ? 'selected' : '' ?>>English Language</option>
                                <option value="Mathematics" <?= $question['category'] === 'Mathematics' ? 'selected' : '' ?>>Mathematics</option>
                                <option value="Civic Education" <?= $question['category'] === 'Civic Education' ? 'selected' : '' ?>>Civic Education</option>
                                <option value="Current Affairs" <?= $question['category'] === 'Current Affairs' ? 'selected' : '' ?>>Current Affairs</option>
                                <option value="French" <?= $question['category'] === 'French' ? 'selected' : '' ?>>French</option>
                                <option value="General Knowledge" <?= $question['category'] === 'General Knowledge' ? 'selected' : '' ?>>General Knowledge</option>
                            </select>
                ...
                <div class="form-group">
                    ...
                    <textarea name="question_text" id="question_text" class="form-control" 
                              rows="3" required placeholder="Enter the question text..."><?= esc($question['question_text']) ?></textarea>
                    ...
                    <div class="col-md-6">
                        <div class="option-group">
                            ...
                            <input type="text" name="option_a" id="option_a" class="form-control" 
                                   value="<?= esc($question['option_a']) ?>" required placeholder="Enter option A...">
                    ...
                    <div class="col-md-6">
                        <div class="option-group">
                            ...
                            <input type="text" name="option_b" id="option_b" class="form-control" 
                                   value="<?= esc($question['option_b']) ?>" required placeholder="Enter option B...">
                    ...
                    <div class="col-md-6">
                        <div class="option-group">
                            ...
                            <input type="text" name="option_c" id="option_c" class="form-control" 
                                   value="<?= esc($question['option_c']) ?>" required placeholder="Enter option C...">
                    ...
                    <div class="col-md-6">
                        <div class="option-group">
                            ...
                            <input type="text" name="option_d" id="option_d" class="form-control" 
                                   value="<?= esc($question['option_d']) ?>" required placeholder="Enter option D...">
                ...
                <div class="form-group">
                    ...
                    <div class="correct-answer-hint">
                        ...
                        Current correct answer: <strong>Option <?= $question['correct_answer'] ?></strong> - 
                        <?= esc($question['option_' . strtolower($question['correct_answer'])]) ?>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="explanation" id="explanation" class="form-control" 
                              rows="2" placeholder="Provide an explanation for the correct answer..."><?= esc($question['explanation']) ?></textarea>
...
document.addEventListener('DOMContentLoaded', function() {
    CBT.showToast('Edit the practice question details and click Update to save changes.', 'info');
});
</script>
<?= $this->endSection() ?>
