...
<div class="row mb-4">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h4 class="fw-bold mb-1">Create New Subject</h4>
                <p class="text-muted mb-0">Add a new subject to the Nigerian school curriculum</p>
            </div>
        ...
        <div class="card form-card">
            <div class="card-header bg-white border-bottom-0 py-3">
                <h5 class="mb-0 fw-semibold">
                    <i class="material-symbols-rounded me-2" style="font-size: 20px;">book</i>
                    Subject Information
                </h5>
            </div>
            <div class="card-body p-4">
                <?= form_open('admin/subjects/create', ['class' => 'needs-validation', 'novalidate' => '']) ?>
                ...
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="material-symbols-rounded me-2" style="font-size: 18px;">save</i>Create Subject
                    </button>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    nameInput.addEventListener('input', function() {
        if (!codeInput.value) {
            ...
            codeInput.value = code.substring(0, 5); // Limit to 5 characters
        }
    });
