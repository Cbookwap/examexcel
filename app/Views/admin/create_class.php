...
<?= $this->section('css') ?>
<style>
    /* OVERRIDE THE MATERIAL DASHBOARD .text-muted RULE */
    ...
    /* Target the specific elements that are being affected */
...
<div class="row mb-4">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h4 class="fw-bold mb-1">Create New Class</h4>
                <p class="text-muted mb-0">Add a new class to the Nigerian school system</p>
            </div>
...
<!-- NOTIFICATION WITH SPECIFIC ID TO OVERRIDE CSS -->
<div id="custom-notification-box" style="background-color: #3b82f6 !important; padding: 20px !important; margin: 20px 0 !important; border-radius: 10px !important;">
    <h3 style="color: #ffffff !important; margin: 0 0 10px 0 !important; font-size: 18px !important;">ℹ️ Automatic Class Teacher Account Creation</h3>

    <p style="color: #ffffff !important; margin: 0 0 15px 0 !important; font-size: 14px !important;">
        When you create a new class, a Class Teacher account will be automatically created for this class.
    </p>

    <div style="color: #ffffff !important; font-size: 13px !important; line-height: 1.5 !important;">
        <div style="margin-bottom: 8px !important;">
            <span style="color: #ffffff !important; font-weight: bold !important;">Username:</span>
            <span style="color: #ffffff !important;">Auto-generated from class name</span>
        </div>
        <div style="margin-bottom: 8px !important;">
            <span style="color: #ffffff !important; font-style: italic !important;">Example: "JSS 1" → "JSS-ONE"</span>
        </div>
        <div style="margin-bottom: 8px !important;">
            <span style="color: #ffffff !important; font-weight: bold !important;">Default Password:</span>
            <span style="color: #ffffff !important; background-color: rgba(0,0,0,0.3) !important; padding: 2px 6px !important; border-radius: 3px !important; font-family: monospace !important;">class123</span>
        </div>
        <div>
            <span style="color: #ffffff !important; font-style: italic !important;">You can change this later in Class Management</span>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-8">
        <div class="card form-card">
            ...
            <div class="card-body p-4">
                <?= form_open('admin/classes/create', ['class' => 'needs-validation', 'novalidate' => '']) ?>
