...
<?= $this->section('title') ?>
Create Subject Category - ExamExcel
<?= $this->endSection() ?>
...
<div class="page-header">
    <div class="container-fluid">
        <div class="row align-items-center">
            <div class="col">
                <h4 class="mb-1 fw-bold">Create Subject Category</h4>
                <p class="mb-0 opacity-8">Add a new category to organize your subjects</p>
            </div>
            <div class="col-auto">
        ...
        <div class="card form-card">
            <div class="card-header">
                <h5 class="mb-0 fw-semibold">
                    <i class="material-symbols-rounded me-2" style="font-size: 20px;">category</i>
                    Category Information
                </h5>
            </div>
            <div class="card-body p-4">
                <?= form_open('admin/subject-categories/create', ['class' => 'needs-validation', 'novalidate' => '']) ?>
                ...
                <div class="mb-3">
                    ...
                    <div class="d-flex align-items-center gap-3 mb-3">
                        <div class="color-preview" id="colorPreview" style="background-color: var(--primary-color);"></div>
                        <input type="color" class="form-control form-control-color <?= $validation->hasError('color') ? 'is-invalid' : '' ?>"
                               id="color" name="color" value="<?= old('color', '#A05AFF') ?>" required>
                ...
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="material-symbols-rounded me-2" style="font-size: 18px;">save</i>Create Category
                    </button>
                </div>
