...
<div class="row mb-4">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h4 class="fw-bold mb-1" style="color: white;">Student Management</h4>
                <p class="text-light mb-0">View and manage all students in the system</p>
            </div>
            <a href="<?= base_url('principal/students/create') ?>" class="btn btn-light">
        ...
        <div class="card stats-card h-100">
            <div class="card-body d-flex align-items-center">
                <div class="flex-grow-1">
                    ...
                    <h3 class="mb-0"><?= number_format($stats['male']) ?></h3>
                </div>
                <div class="stats-icon">
        ...
        <div class="card stats-card h-100">
            <div class="card-body d-flex align-items-center">
                <div class="flex-grow-1">
                    ...
                    <h3 class="mb-0"><?= number_format($stats['female']) ?></h3>
                </div>
                <div class="stats-icon">
...
<div class="card filter-card mb-4">
    <div class="card-body">
        <form method="GET" action="<?= base_url('principal/students') ?>">
            ...
            <div class="row">
                <div class="col-12">
                    <a href="<?= base_url('principal/students') ?>" class="btn btn-clear btn-sm">
                ...
                <table class="table table-hover mb-0" id="studentsTable">
                    <thead>
                        <tr>
                            ...
                            <th class="border-0 fw-semibold">Student ID</th>
        ...
        <?php else: ?>
            <div class="empty-state">
                ...
                <?php if (!empty($filters['search']) || !empty($filters['class']) || !empty($filters['gender'])): ?>
                    ...
                    <a href="<?= base_url('principal/students') ?>" class="btn btn-primary">
                        <i class="material-symbols-rounded me-2">clear</i>Clear Filters
                    </a>
                <?php else: ?>
                    <p>No students have been added to the system yet.</p>
                    <a href="<?= base_url('principal/students/create') ?>" class="btn btn-primary">
