    ...
    <div class="col-lg-8">
        <div class="card profile-card">
            ...
            <div class="card-body">
                ...
                <!-- Profile Form -->
                <?= form_open('principal/profile', ['class' => 'needs-validation', 'novalidate' => true]) ?>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="title" name="title"
                                   value="<?= old('title', $user['title']) ?>" placeholder="e.g., Dr., Prof., Mr., Mrs.">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="d-flex justify-content-between">
                                <a href="<?= base_url('principal/dashboard') ?>" class="btn btn-outline-secondary">
