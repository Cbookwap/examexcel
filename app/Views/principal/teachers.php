...
<div class="row mb-4">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h4 class="fw-bold mb-1" style="color: white;">Teacher Management</h4>
                <p class="text-light mb-0">View and manage all teachers in the system</p>
            </div>
            <a href="<?= base_url('principal/teachers/create') ?>" class="btn btn-light">
...
<div class="card filter-card mb-4">
    <div class="card-body">
        <form method="GET" action="<?= base_url('principal/teachers') ?>">
            ...
            <div class="row">
                <div class="col-12">
                    <a href="<?= base_url('principal/teachers') ?>" class="btn btn-clear btn-sm">
        ...
        <?php else: ?>
            <div class="empty-state">
                ...
                <?php if (!empty($filters['search']) || !empty($filters['department']) || !empty($filters['gender'])): ?>
                    ...
                    <a href="<?= base_url('principal/teachers') ?>" class="btn btn-primary">
                        <i class="material-symbols-rounded me-2">clear</i>Clear Filters
                    </a>
                <?php else: ?>
                    <p>No teachers have been added to the system yet.</p>
                    <a href="<?= base_url('principal/teachers/create') ?>" class="btn btn-primary">
