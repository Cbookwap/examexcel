...
class ClassTeacherFilter implements FilterInterface
{
    public function before(RequestInterface $request, $arguments = null)
    {
        ...
        // Check if user has class_teacher role
        if ($session->get('role') !== 'class_teacher') {
            ...
            return redirect()->to($redirectUrl)->with('error', 'Access denied. Class teacher privileges required.');
        }
    }
