...
class AdminFilter implements FilterInterface
{
    public function before(RequestInterface $request, $arguments = null)
    {
        ...
        // Check if user is admin or principal (principals have same rights as admin for exam management)
        if (!in_array($session->get('role'), ['admin', 'principal'])) {
            ...
            } elseif ($userRole === 'class_teacher') {
                $redirectUrl = '/class-teacher/dashboard';
            }

            return redirect()->to($redirectUrl)->with('error', 'Access denied. Admin or Principal privileges required.');
        }
    }
